...
import Left12 from '../page/Left12.vue'
import Left11 from '../page/Left11.vue'
import center11 from '../page/center11.vue'
import Right11 from '../page/Right11.vue'


export default defineComponent({
  components: {
     Center1,Center2,Left1,Right1,Left12,Left11,center11,Right11
  },
  setup() {
    // * 颜色
